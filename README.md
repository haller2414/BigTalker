...
3. On the "*New SmartApp*" page, Select the Tab "**From Code**" , Copy the BigTalker source code from GitHub (*https://github.com/rayzurbock/SmartThings-BigTalker/blob/development/smartapps/rayzurbock/big-talker.src/big-talker.groovy*) and paste it into the IDE editor window.
